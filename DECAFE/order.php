        ...
        <div class="modal-dialog modal-lg modal-fullscreen-md-down">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Order Baru</h1>
            ...
            <div class="modal-body">
              ...
              <form class="needs-validation" novalidate action="proses/proses_input_order.php" method="POST">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" name="input_order_validate" value="12345">Order Pesanan</button>
                </div>
              </form>
            </div>
          </div>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?php echo (!empty($row['id_bayar'])) ? "<span class='badge text-bg-success'>Lunas</span>" : "" ; ?></td>
