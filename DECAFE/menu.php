                ...
                <div class="row">
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">
                        Masukkan Kategori Menu Makanan dan Minuman.
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
            ...
            <div class="modal-body">
              ...
              <form class="needs-validation" novalidate action="proses/proses_edit_menu.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="harga" name="harga" required  value="<?php echo $row['harga'] ?>" accept="">
                      <label for="floatingInput">Harga</label>
                        <div class="invalid-feedback">
                        Masukkan Harga Menu
                      </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="stok" name="stok" required  value="<?php echo $row['stok'] ?>" accept="">
                      <label for="floatingInput">Stok</label>
                        <div class="invalid-feedback">
                        Masukkan Stok Menu
                      </div>
                ...
                <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                  ...
                  <div class="col-lg-12">
                    ...
                    if ($row['username'] == $_SESSION['username_decafe']) {
                      echo "<div class='alert alert-danger'>Anda Tidak Bisa Menghapus Akun Sendiri
                              </div>";
                    } else {
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                  ...
                  <div class="col-lg-12">
                    <?php
                    if ($row['username'] == $_SESSION['username_decafe']) {
                      echo "<div class='alert alert-danger'>Anda Tidak Bisa Mereset Password Sendiri
                              </div>";
                    } else {
                ...
                <tr>
                  ...
                  <td>
                    <div style="width: 90px">
                      <img src="assets/img/menu/<?php echo $row['foto'] ?>" class="img-thumbnail" alt="...">
                    </div>
                  </td>
