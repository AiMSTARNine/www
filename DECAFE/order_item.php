...
<div class="col-lg-9 mt-2">
  <div class="card">
    ...
    <div class="card-body">
      <a href="order" class="btn btn-info mb-3"><i class="bi bi-arrow-90deg-left"></i></a>
      <div class="row">
        <div class="col-lg-3">
            ...
            <div class="modal-body">
              ...
              <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    <div class="form-floating mb-3">
                      <input type="number" class="form-control" id="floatingInput" placeholder="Jumlah Porsi" name="jumlah_porsi" required>
                ...
                <div class="modal-body">
                  ...
                  <form class="needs-validation" novalidate action="proses/proses_edit_order_item.php" method="POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4">
                        <div class="form-floating mb-3">
                          <input type="number" class="form-control" id="floatingInput" placeholder="Jumlah Porsi" name="jumlah_porsi" required value="<?php echo $row['jumlah'] ?>">
                          <label for="floatingInput">Jumlah Porsi</label>
                          <div class="invalid-feedback">
                            Masukkan Jumlah Porsi.
                          </div>
              ...
              <div class="modal-body">
                ...
                <form class="needs-validation" novalidate action="proses/proses_bayar.php" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="floatingInput" placeholder="Nominal Uang" name="nominal_uang" required>
